        ...
        <>
            <div className="maidivbestEvery" >
                ...
                <div className='productmainEvery' key={id}>
                     <nav><Link to='/ProductCount'><img className="productimgEvery"  src={Product.image} alt='image'/></Link></nav> 
                      <p>{Product.type}</p>
                      <h2 className="productnameheadEvery"> {Product.productname}</h2>
                      <div className="starEvery"><img className="productimgstarEvery" src={Product.star} alt='image'/>
                      <p className="priceparaEvery"> {Product.price}</p></div>
                </div>) )}
